...
The table above, shows that for both OJ and VC, when compared independently, hava P-Values close to zero with negative intervals, showing that larger doses influence on tooth length.
